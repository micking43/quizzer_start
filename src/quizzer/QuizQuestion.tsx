...
export const QuizQuestion = ({
    ...
    addPoints,
    editQuestionSub
}: {index: number, question: Question, submitted: boolean, handleSubmit: (index: number) => void, addPoints: (number: number) => void, editQuestionSub: (id: number, sub: string) => void}) => {
